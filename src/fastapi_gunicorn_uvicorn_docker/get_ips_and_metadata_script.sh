...
printf "\nKAFKA_TOPIC_PARTITIONS=$KAFKA_TOPIC_PARTITIONS" >> /opt/fastapi_gunicorn_uvicorn_docker/app/.env.example
printf "\nKAFKA_TOPIC_REPLICAS=$KAFKA_TOPIC_REPLICAS" >> /opt/fastapi_gunicorn_uvicorn_docker/app/.env.example
